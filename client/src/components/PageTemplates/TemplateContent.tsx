...
const PageViewsPanel = lazy(() => import('components/PagePanels - Checked/Views'))
const NotionTemplate = lazy(() => import('components/PageTemplates - Checked/Notion - Checked'))
const NotionsListTemplate = lazy(() => import('components/PageTemplates - Checked/NotionsList  - Checked'))
