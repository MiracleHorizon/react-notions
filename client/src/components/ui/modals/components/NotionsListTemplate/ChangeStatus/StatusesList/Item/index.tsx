...
const StatusListItem: FC<PropTypes> = ({ list, task }) => {
  const {
  ...
  return (
    <Item.Wrapper ref={ref} onClick={handleChangeTaskStatus}>
      <Item.Container>
        <TasksListStatusContainer {...list} />
        <Item.ButtonContainer ref={optionsBtnRef} isHovering={inHovering}>
          <OptionsButton
            size='medium'
            type='primary'
